                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-bordered table-striped table-actions dataTable">
                                        ...
                                        $tutor_main_select_query = "SELECT u.code,u.name,u.gender,u.date_of_birth,u.nic_no,u.mobile_no,u.email,u.address 
                                            ...
                                            AND u.id IN (SELECT DISTINCT u.id FROM user u, login l, role r WHERE u.id = l.user_id AND r.login_id = l.id 
                                                ...
                                                GROUP BY m.user_id HAVING COUNT(m.user_id) >= 10)) ORDER BY u.code";
