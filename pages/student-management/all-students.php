                ...
                <table class="table table-bordered table-striped table-actions datatable">
                    ...
                    <tbody>
                        <?php 
                            ...
                            INNER JOIN role ON login.id = role.login_id
                            WHERE
                            role.permission_id = '3' AND user.status = 1";
                        ...
                        <tr id="trow_1">
                            ...
                            <td>
                                ...
                                <button value="<?php echo $row_data['id']; ?>" class="btn btn-danger btn-rounded btn-condensed btn-sm delete" onClick="delete_row('trow_1');"><span class="fa fa-times"></span></button>
                            </td>
                        </tr>
                        <?php 
                            }
