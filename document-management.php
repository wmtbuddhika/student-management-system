...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2 class="text-uppercase">document Management</h2>
        </div>
        <!-- END PAGE TITLE -->

        <!-- PAGE CONTENT WRAPPER -->
        <div class="page-content-wrap">
            <?php require_once('pages/document-management/document-upload.php'); ?>

            <?php require_once('pages/document-management/uploaded-documents.php'); ?>

            <?php require_once('pages/document-management/document-comments.php'); ?>
        </div>
